...
class EncounterManager extends Component {
  ...
  componentDidMount() {
    ...
    //
    // }
    console.log(recievedMonsters, recievedPlayers);
    var monsterList = this.generateMonsterInitiatives(recievedMonsters);
    this.rankedList = this.getIntiativeRanking(recievedMonsters, recievedPlayers);
